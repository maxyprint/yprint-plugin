...
class YPrint_Design_Share_Page {
    ...
    private static function get_design_data($design_id) {
        ...
        $designer_info = self::get_designer_info($design->user_id);
     ...
     * Get designer information
     */
    private static function get_designer_info($user_id) {
        if (!$user_id) {
            return array(
                'name' => 'Unbekannter Designer',
                'display_name' => 'Unbekannter Designer'
            );
        }
        ...
        // Use display name, or fallback to first name + last name, or username
            ...
            <div class="design-info">
                ...
                <div class="design-meta">
                    <div class="meta-item">
                        ...
                        <span>Designer: <?php echo esc_html($design['designer']['display_name']); ?></span>
                    </div>
                    <div class="meta-item">
