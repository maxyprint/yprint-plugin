...
<div class="order-summary-bold-final">
    ...
    <?php 
    // Angewandte Gutscheine anzeigen (nur die angezeigten Gutscheine, ohne Eingabefeld)
    $cart_data_manager = YPrint_Cart_Data::get_instance();
    $applied_coupons = $cart_data_manager->get_applied_coupons();
    if (!empty($applied_coupons)): ?>
        <div class="applied-coupons mt-4">
            <h4 class="text-sm font-medium text-yprint-black mb-2"><?php esc_html_e('Angewandte Gutscheine:', 'yprint-checkout'); ?></h4>
